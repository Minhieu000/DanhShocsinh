...
namespace DanhShocsinh
{
    internal class DShocsinh

    {
        ...
        { // Tao danh sach học sinh
            List<Student> students = new List<Student>
            {
                ...
                new Student { Id = 2, Name = "Bich", Age = 19 },
                new Student { Id = 3, Name = "Duy", Age = 18 },
                new Student { Id = 4, Name = "Huyen", Age = 17 },
                new Student { Id = 5, Name = "Hai", Age = 19 }
            };
